...
const router = createBrowserRouter([
  ...
  {
    path: '/add',
    element: <LazyWrapper><AddRecord /></LazyWrapper>,
    errorElement: <RouteError />,
  },
  {
    path: '/add-record',
  ...
  {
    path: '/savings',
    element: <LazyWrapper><Savings /></LazyWrapper>,
    errorElement: <RouteError />,
  },
  {
    path: '/profile',
  ...
  },
  {
    ...
    element: <LazyWrapper><CategoryManage /></LazyWrapper>,
    errorElement: <RouteError />,
  },
  {
    path: '/budget',
    element: <LazyWrapper><Budget /></LazyWrapper>,
    errorElement: <RouteError />,
  },
  {
    path: '/changelog',
    element: <LazyWrapper><Changelog /></LazyWrapper>,
    errorElement: <RouteError />,
  },
  {
    path: '/features',
